...
class Provenance(BaseModel):
    """
    Base provenance information for tracking the origin of extracted data.

    This is a lightweight base class. For more detailed extraction provenance,
    see ExtractionProvenance in entity.py.

    Attributes:
        source: Source identifier (e.g., paper_id, extraction_pipeline_name)
        timestamp: When this data was created/extracted
