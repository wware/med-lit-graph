...
def create_relationship(predicate: PredicateType, subject_id: str, object_id: str, **kwargs) -> BaseMedicalRelationship | ResearchRelationship:
    ...
    relationship_classes = {
        CausalPredicateType.CAUSES: Causes,
        TreatmentPredicateType.TREATS: Treats,
        CausalPredicateType.INCREASES_RISK: IncreasesRisk,
        DiagnosticPredicateType.ASSOCIATED_WITH: AssociatedWith,
        DrugInteractionPredicateType.INTERACTS_WITH: InteractsWith,
        DiagnosticPredicateType.DIAGNOSED_BY: DiagnosedBy,
        TreatmentPredicateType.SIDE_EFFECT: SideEffect,
        BiologicalPredicateType.ENCODES: Encodes,
        BiologicalPredicateType.PARTICIPATES_IN: ParticipatesIn,
        TreatmentPredicateType.CONTRAINDICATED_FOR: ContraindicatedFor,
        ProvenancePredicateType.CITES: Cites,
        ProvenancePredicateType.STUDIED_IN: StudiedIn,
        ProvenancePredicateType.AUTHORED_BY: AuthoredBy,
        ProvenancePredicateType.PART_OF: PartOf,
        ProvenancePredicateType.PREDICTS: Predicts,
        ProvenancePredicateType.REFUTES: Refutes,
        ProvenancePredicateType.TESTED_BY: TestedBy,
        ProvenancePredicateType.GENERATES: Generates,
    }
