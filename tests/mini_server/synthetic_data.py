    ...
    relationships.append(
        {
            ...
            "metadata": {"response_rate": 0.75, "study_type": "rct", "sample_size": 1250, "phase": "III"},
        }
    )
    ...
    relationships.append(
        {
            ...
            "metadata": {"response_rate": 0.82, "study_type": "rct", "sample_size": 980, "phase": "III", "her2_positive": True},
        }
    )
    ...
    relationships.append(
        {
            ...
            "evidence_count": 1,
            "papers": ["PMC123456"],
            "metadata": {"response_rate": 0.599, "study_type": "rct", "sample_size": 302, "phase": "III"},
        }
    )
    ...
    relationships.append(
        {
            ...
            "evidence_count": 1,
            "papers": ["PMC234567"],
            "metadata": {"study_type": "cohort", "sample_size": 450},
        }
    )
    ...
    relationships.append(
        {
            ...
            "evidence_count": 1,
            "papers": ["PMC234567"],
            "metadata": {"study_type": "rct", "sample_size": 320},
        }
    )
    ...
    relationships.append(
        {
            ...
            "metadata": {"efficacy": 0.78, "adverse_events": ["GI upset", "lactic acidosis (rare)"]},
        }
    )
    ...
    relationships.append(
        {
            ...
            "metadata": {"risk_reduction": 0.25, "study_type": "meta_analysis"},
        }
    )
...
def load_all_synthetic_data():
    ...
    return {"entities": generate_entities(), "relationships": generate_relationships(), "papers": generate_papers()}
